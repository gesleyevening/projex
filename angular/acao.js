angular.module('myApp').controller(
    'dadosController', ['$scope', '$location', 'UsuarioService', '$sessionStorage', 'AcaoService', 
    'TipoAcaoService',
    function($scope, $location, UsuarioService, $sessionStorage, AcaoService, TipoAcaoService) {
