angular.module('myApp').service('UsuarioService', ['$http', '$localStorage', '$sessionStorage', '$window', 'UtilService',
    function($http, $localStorage, $sessionStorage, $window, UtilService) {
        var sair = function() {
            $http({
                method: "POST",
                //data: user,
                ...
                UtilService.alertaErro("Ocorreu um erro ao tentar salvar. ");
            });
